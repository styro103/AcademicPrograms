...
{	
	...
	if (p==2)
	{
		...
		{	
			...
			{
				cout<<"Sorry, that column is invalid. Choose a column from 1-7, or 0 to quit. ";
				cin>>column;
			}
			if (pl==1)
			{
	...
	else if (p==1)
	{
		...
		{	
			if(pl==1)
			{
				cout<<"What column would player like to play? (0 to quit) "<<endl;
				cin>>column;
			}
			if (column==0)
			{
				cout<<""<<endl;
				cout<<"Player quits, computer wins."<<endl;
				outfile<<"Player quits, computer wins."<<endl;
				cout<<""<<endl;
				break;
			}
			while(column<0 || column>7)
			...
			{	
				...
				if(pl==1)
				{
					outfile<<"Player plays in column "<<column<<"."<<endl;
				}
				else
				{
...
{	
	...
	else
	{
		...
		{
			cout<<"Draw game."<<endl;
			outfile<<"Draw game, no one wins."<<endl;
		}*/
		//else
		//{
			pl=pl*-1;
