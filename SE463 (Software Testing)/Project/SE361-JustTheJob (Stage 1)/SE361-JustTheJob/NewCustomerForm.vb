Public Class NewCustomerForm
    ...
    Private Sub btnNCSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNCSubmit.Click
        ...
        Dim infoCorrect As Boolean

        infoCorrect = checkInfo()

        If infoCorrect = True Then
            customerList.addCustomer(txtNCName.Text, txtNCAddress.Text, txtNCPhone.Text, txtNCEmail.Text)

            'insert into listboxes
            customerList.viewCustomerName(CustomerListForm.lstName)
            customerList.viewCustomerAddress(CustomerListForm.lstAddress)
            customerList.viewCustomerPhone(CustomerListForm.lstPhone)
            customerList.viewCustomerEmail(CustomerListForm.lstEmail)
    ...
    Function checkFieldsFilled() As Boolean
